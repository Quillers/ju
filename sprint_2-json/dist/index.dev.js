...
app.set('view engine', 'ejs'); // On indique d'utiliser le module de parsing pour récup les formulaires.
...
app.use(topicRouteur); // On envoi 404 si la requête arrive jusqu'ici :

app.use(mw.throw404); // On lance le serveur
